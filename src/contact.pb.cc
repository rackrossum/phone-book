...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ContactListDefaultTypeInternal _ContactList_default_instance_;
}  // namespace PhoneBookSerialize
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 9, -1, -1, sizeof(::PhoneBookSerialize::Contact)},
  { 18, -1, -1, sizeof(::PhoneBookSerialize::ContactList)},
};
...
void ContactList::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ContactList *>(to)->MergeFrom(
      static_cast<const ContactList &>(from));
}
